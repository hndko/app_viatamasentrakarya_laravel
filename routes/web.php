...
Route::prefix('auth')->namespace('Backend\Auth')->middleware('guest')->group(function () {
...
Route::prefix('apps')->namespace('Backend\APPS')->group(function () {
    Route::middleware('check.role:superadmin,admin 1,admin 2')->group(function () {
        ...
        Route::get('data_akun', [APPSUserController::class, 'index'])->name('apps.data_akun');
        Route::get('data_akun/create', [APPSUserController::class, 'create'])->name('apps.data_akun.create');
        Route::post('data_akun', [APPSUserController::class, 'store'])->name('apps.data_akun.store');
        Route::get('data_akun/{id}/edit', [APPSUserController::class, 'edit'])->name('apps.data_akun.edit');
        Route::put('data_akun/{id}/update', [APPSUserController::class, 'update'])->name('apps.data_akun.update');
        Route::delete('data_akun/{id}', [APPSUserController::class, 'destroy'])->name('apps.data_akun.destroy');
    });
});
...
Route::prefix('cms')->namespace('Backend\CMS')->group(function () {
    Route::middleware('check.role:admin content')->group(function () {
