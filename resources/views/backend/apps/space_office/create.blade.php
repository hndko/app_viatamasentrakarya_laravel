                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            ...
                            <form action="{{ route('apps.space_office.store') }}" method="POST"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="date" class="form-control" name="awal_sewa" id="awal_sewa"
                                                autocomplete="off" value="{{ old('awal_sewa') }}">
                                            @error('awal_sewa')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-sm-5">
                                            <input type="date" class="form-control" name="akhir_sewa" id="akhir_sewa"
                                                autocomplete="off" value="{{ old('akhir_sewa') }}">
                                            @error('akhir_sewa')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input"
                                                        name="bukti_pembayaran" id="bukti_pembayaran" required>
