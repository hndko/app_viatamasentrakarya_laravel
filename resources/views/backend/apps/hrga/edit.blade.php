                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            ...
                            <form action="{{ route('apps.hrga.update', $hrga->hrga_id) }}" method="POST"
                                            ...
                                            <select name="perusahaan_id" id="perusahaan_id" class="form-control select2bs4"
                                                ...
                                                @foreach ($perusahaan as $res)
                                                    <option value="{{ $res->perusahaan_id }}"
                                                        {{ $hrga->perusahaan_id == $res->perusahaan_id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="date" class="form-control" name="tanggal_masuk"
                                                id="tanggal_masuk" autocomplete="off" value="{{ $hrga->tanggal_masuk }}">
                                            @error('tanggal_masuk')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="no_telpon" id="no_telpon"
                                                placeholder="No Telpon" autocomplete="off" value="{{ $hrga->no_telpon }}"
                                                maxlength="20">
                                            @error('no_telpon')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="jabatan" id="jabatan"
                                                placeholder="Jabatan" autocomplete="off" value="{{ $hrga->jabatan }}">
                                            @error('jabatan')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="nik" id="nik"
                                                placeholder="NIK" autocomplete="off" value="{{ $hrga->nik }}"
                                                maxlength="30">
                                            @error('nik')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="lokasi" id="lokasi"
                                                placeholder="Lokasi" autocomplete="off" value="{{ $hrga->lokasi }}"
                                                maxlength="20">
                                            @error('lokasi')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="bpjs_kesehatan"
                                                ...
                                                value="{{ $hrga->bpjs_kesehatan }}" maxlength="20">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="bpjs_tk" id="bpjs_tk"
                                                placeholder="BPJS TK" autocomplete="off" value="{{ $hrga->bpjs_tk }}"
                                                maxlength="20">
                                            @error('bpjs_tk')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="date" class="form-control" name="pkwt_awal" id="pkwt_awal"
                                                autocomplete="off" value="{{ $hrga->pkwt_awal }}" required>
                                            @error('pkwt_awal')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-sm-5">
                                            <input type="date" class="form-control" name="pkwt_akhir" id="pkwt_akhir"
                                                autocomplete="off" value="{{ $hrga->pkwt_akhir }}" required>
                                            @error('pkwt_akhir')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="kasbon" id="kasbon"
                                                placeholder="Kasbon" autocomplete="off" value="{{ $hrga->kasbon }}"
                                                maxlength="20">
                                            @error('kasbon')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
