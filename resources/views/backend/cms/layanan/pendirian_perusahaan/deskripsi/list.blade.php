                                ...
                                <div class="modal fade" id="modalTambahData" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form
                                                action="{{ route('cms.pendirian_perusahaan.list_store', $layanan->layanan_id) }}"
                                                method="POST">
                                                @csrf
                                        ...
                                        @foreach ($result as $res)
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    ...
                                                    <form
                                                        action="{{ route('cms.pendirian_perusahaan.list_destroy', $res->deskripsi_id) }}"
                                            ...
                                            <div class="modal fade" id="modalEditData{{ $res->deskripsi_id }}"
                                                ...
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form
                                                            action="{{ route('cms.pendirian_perusahaan.list_update', $res->deskripsi_id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="modal-body">
