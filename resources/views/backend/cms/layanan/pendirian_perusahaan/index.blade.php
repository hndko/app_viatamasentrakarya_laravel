                            ...
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <button type="button" class="btn btn-primary btn-sm"
                                        onclick="window.location.href='{{ route('cms.pendirian_perusahaan.create') }}'">Tambah
                                        Data</button>
                                </div>
                            </div>
                            <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    ...
                                                    <button type="button" class="btn btn-warning btn-sm"
                                                        onclick="window.location.href='{{ route('cms.pendirian_perusahaan.edit', $res->layanan_id) }}'">
                                                        <i class="fas fa-edit"></i>
                                                    </button>

                                                    <!-- Tombol untuk menghapus -->
                                                    <form
                                                        action="{{ route('cms.pendirian_perusahaan.destroy', $res->layanan_id) }}"
                                                    ...
                                                    <button type="button" class="btn btn-info btn-sm"
                                                        onclick="window.location.href='{{ route('cms.pendirian_perusahaan.list', $res->layanan_id) }}'">
