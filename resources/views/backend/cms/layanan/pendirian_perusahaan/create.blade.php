                            ...
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <button type="button" class="btn btn-primary btn-sm"
                                        onclick="window.location.href='{{ route('cms.pendirian_perusahaan') }}'">Kembali</button>
                                </div>
                            </div>
                            <form action="{{ route('cms.pendirian_perusahaan.store') }}" method="POST">
                                @csrf <!-- Token CSRF -->
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="judul" id="judul"
                                                placeholder="Judul" autocomplete="off" required value="{{ old('judul') }}">
                                            @error('judul')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="harga" id="harga"
                                                placeholder="Harga" autocomplete="off" required value="{{ old('harga') }}">
                                            @error('harga')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-sm-4 mt-1">
                                            ...
                                            <input type="checkbox" name="is_harga" id="is_harga" value="1"
                                                {{ old('is_harga') ? 'checked' : '' }} data-bootstrap-switch
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="is_color" id="is_color" class="form-control" required>
                                                ...
                                                <option value="featured-teal">featured-teal</option>
                                                <option value="featured">featured</option>
                                                <option value="featured-red">featured-red</option>
                                            </select>
                                            @error('is_color')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10 mt-1">
                                            ...
                                            <input type="checkbox" name="is_whatsapp" id="is_whatsapp" value="1"
                                                {{ old('is_whatsapp') ? 'checked' : '' }} data-bootstrap-switch
                                                data-off-color="danger" data-on-color="success">
                                            @error('is_whatsapp')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10 mt-1">
                                            ...
                                            <input type="checkbox" name="is_active" id="is_active" value="1"
                                                {{ old('is_active') ? 'checked' : '' }} data-bootstrap-switch
                                                data-off-color="danger" data-on-color="success">
                                            @error('is_active')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
