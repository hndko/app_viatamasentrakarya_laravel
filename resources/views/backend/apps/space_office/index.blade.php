                            ...
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <button type="button" class="btn btn-primary btn-sm"
                                        onclick="window.location.href='{{ route('apps.space_office.create') }}'">Tambah
                                        Data</button>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        @foreach ($result as $res)
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    Rp{{ number_format($res->pph_final, 0, ',', '.') }}
                                                </td>
                                                <td class="align-middle">
                                                ...
                                                <td class="align-middle">
                                                    <span style="cursor: pointer" data-toggle="modal"
                                                        data-target="#buktiModal{{ $res->form_so_id }}">Klik
                                                        Here</span>
                                                </td>
                                                ...
                                                <td class="align-middle">
                                                    ...
                                                    <button type="button" class="btn btn-warning btn-sm"
                                                        onclick="window.location.href='{{ route('apps.space_office.edit', $res->form_so_id) }}'">
                                                        <i class="fas fa-edit"></i>
                                                    </button>

                                                    <!-- Tombol untuk menghapus -->
                                                    <form
                                                        action="{{ route('apps.space_office.destroy', $res->form_so_id) }}"
                                        ...
                                        @foreach ($result as $res)
                                            <div class="modal fade" id="buktiModal{{ $res->form_so_id }}" tabindex="-1"
